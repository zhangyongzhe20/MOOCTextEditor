...
//		// After gettoken, restore back the orinal string
//		if(words.size() != 1 && word.charAt(word.length()-1) == 'e') {
//			String StrNew = word.substring(0, word.length()-1);
//			text = StrNew;
//		}
//		List<String> words2 = getTokens("[aAeEIiOoUuYy]+");
//		text = text_;
//	   return words2.size();
